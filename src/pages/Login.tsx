  ...
  return (
    <div className="min-h-screen bg-surface relative flex items-center justify-center px-4">
      ...
      <motion.div 
        ...
        className="max-w-md w-full bg-surface/80 backdrop-blur-xl border border-primary/30 p-4 md:p-8 rounded-sm relative z-10"
      >
        <div className="text-center mb-8">
          ...
          <p className="text-white text-[10px] uppercase tracking-[0.3em]">Initialize Secure Session</p>
        </div>
        ...
        <p className="mt-8 text-center text-white/40 text-[10px] uppercase tracking-widest">
          No account? <Link to="/signup" className="text-primary hover:text-white transition-colors underline">Create Protocol</Link>
        </p>
      </motion.div>
    </div>
  );
